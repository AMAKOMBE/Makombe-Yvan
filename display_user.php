            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-5">
                ...
                <table class="table my-3" width="100%" id="user_table">
                    ...
                    <tbody>
                        ...
                        $sql = "select * from school where name not like 'Rwanda Education Board' order by name asc";
                        ...
                        if ($result) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '
                                    ...
                                    <!--<button class="btn btn-danger"><a href="remove_user.php?
                                    userRemove=' . $id . '" class="text-light">Remove</a></button>--!>
                                    </td>
                                    </tr>
                                    ';
                            }
