    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-5">
                ...
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">JANUARY</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">FEBRUARY</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">MARCH</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">APRIL</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">MAY</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">JUNE</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">JULY</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">AUGUST</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">SEPTEMBER</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">OCTOBER</a></span>
                <span><a href="admin_report.php" class="btn btn-outline-secondary active">NOVEMBER</a></span>
                <span><a href="admin_report_d.php" class="btn btn-outline-secondary">DECEMBER</a></span><br>
                <br>
