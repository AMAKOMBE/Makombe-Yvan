        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-5">
                ...
                <div>
                    ...
                    $sql = "SELECT distinct COUNT(s_id) as num from student";
                    $result = mysqli_query($con, $sql);
                    $row = mysqli_fetch_assoc($result);
                    $total_student = $row['num'];
                    ?>
                    <p style="font-size:120%;">As of the Academic year of <b>2021/2022</b> shows the total number of student attending primary schools in Rwanda, learning according to the
                        Rwanda Education Board curriculum is <b><?php echo $total_student; ?> Students</b>. With the help of gathered student information, below shows the current
                        country statistics of student Parent's or Guardian's basing on their <i>Employment status</i> and <i>Education level status</i>:
                    </p>
                </div>
                <div class="d-flex justify-content-around">
                    <div id="Occupationchart" style="width: 1800px; height: 475px;"></div>
                    <div id="Educationchart" style="width: 1800px; height: 475px;"></div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                <?php
                $con = mysqli_connect('localhost', 'root', '', 'education');
                $sql = "SELECT distinct COUNT(p_id) as num,p_occupation from student GROUP BY p_occupation";
                $result = mysqli_query($con, $sql);
            ...
            var options = {
                title: 'Parent/Guardian Employment status'
            };
        ...
        function drawChart1() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                <?php
                $con = mysqli_connect('localhost', 'root', '', 'education');
                $sql = "SELECT distinct COUNT(p_id) as num,p_education_level from student GROUP BY p_education_level";
                $result = mysqli_query($con, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
            ...
            var options = {
                title: 'Parent/Guardian Education Level status'
            };
